...
import {HOME_PAGE_KEY, homePageReducer} from "../../containers/client/Home/store/reducer";
import {ADMIN_HOME_PAGE_KEY, AdminHomePageReducer} from "../../containers/admin/Home/store/reducer";
import {ANIMALS_KEY, animalsReducer} from '../../containers/client/Animals/store/reducer';
import {BLOGS_KEY, blogsReducer} from '../../containers/client/Blog/store/reducer';
...
import {BLOG_ITEM_KEY, blogItemReducer} from '../../containers/client/Blog/store/reducer/blogitem.reducer';
...
import {financialReportReducer, REPORT_KEY} from "../../containers/client/FinancialReports/store/reducer";
import {ADMIN_LOGIN_KEY, AdminLoginReducer} from "../../containers/admin/Login/store/reducer";
import {YOUTUBE_VIDEOS_KEY, youtubeVideosReducer} from "./youtube-videos.reducer";
...
import {ADMIN_LOCATIONS_KEY, adminLocationsReducer} from "../../containers/admin/Locations/store/reducer";
