...
export const AdminHomePageReducer = (
  ...
  switch (action.type) {
    ...
    case getType(actionAdminPostAnimalRequest):
      return {
        ...state,
        animalPostRequestState: postAnimalsRequestStateReducer(
          state.animalPostRequestState,
          action,
        ),
      };
    ...
    case getType(actionAdminUpdateAnimalRequest):
      return {
        ...state,
        animalUpdateRequestState: updateAnimalsRequestStateReducer(
          state.animalUpdateRequestState,
          action,
        ),
      };
    ...
    case getType(actionAdminDeleteAnimalRequest):
      return {
        ...state,
        animalDeleteRequestState: deleteAnimalsRequestStateReducer(
          state.animalDeleteRequestState,
          action,
        ),
      };
    ...
    case getType(actionAdminFetchAllLocationsRequest):
      return {
        ...state,
        requestState: fetchAdminHomePageLocationsRequestStateReducer(
          state.animalsLocations.requestState,
          action,
        ),
      };
