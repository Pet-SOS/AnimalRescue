  ...
  return (
    <BlogContainerPage>
      ...
      <div className="buttons-container">
        <BlogFilter initial={search} filterItemInBlog={filterItemInBlog} />
        <div
          className="button-add-new-article"
      ...
      <div className="section-table-wrapper">
        <div className={'section-table blog-table'}>
          ...
          {blogList.data &&
            blogList.data.map((item: IBlogItem, i: number) => (
              <BlogListItem
                key={i}
                blogItem={item}
