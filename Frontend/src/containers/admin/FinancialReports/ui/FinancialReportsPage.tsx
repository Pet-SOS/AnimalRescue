...
import {
  ...
  IInfoFile, fetchFinancialReporDocument
                    ...
                    <section className="section-all-reports">
                      ...
                      <div className="inner-all-reports">
                        <Tabs defaultActiveKey="1" tabPosition='top'>
                          {reversedFinanceReports.map((report: IFinancialReport, i: number) => (
                              ...
                              <div className="list-reports">
                                {report.reports.map((infoFile) => (
                                  <div key={infoFile.id} className='report'>
                                    ...
                                    <div onClick={() => this.openPdfFile(infoFile)} className="title-item">
                                      <TI18n keyStr={`dateText${moment(infoFile.date).month()}`}/>
                                      <span className='year-report'>{moment(infoFile.date).year()}</span></div>
                                    <button onClick={() => {
                                      this.deleteReport(infoFile.id, infoFile.title)
