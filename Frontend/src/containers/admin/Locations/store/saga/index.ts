...
import {
    actionAdminCreateLocationRequest, actionAdminDeleteLocationRequest,
    actionAdminFetchLocationsRequest,
    actionAdminUpdateLocationRequest
} from "../actions";
import {fetchLocationsSaga} from "./fetchLocationSaga";
import {createLocationsSaga, deleteLocationsSaga, editLocationsSaga} from "./editLocationSaga";
...
export function* watchAdminLocationSaga() {
    ...
    yield takeEvery(getType(actionAdminDeleteLocationRequest), deleteLocationsSaga);
}
