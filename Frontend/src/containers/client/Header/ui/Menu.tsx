    ...
    <>
      <ul className="nav-list">
        <li className="nav-item">
          <NavLink to="/">
            <TI18n keyStr="headerMenuItem0" />
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/animals/page/1">
            <TI18n keyStr="headerMenuItem2" />
          </NavLink>
        </li>
        <li
          className={stateMenu.drop3 ? 'active nav-item drop' : 'nav-item drop'}
          onClick={e => openedMenu(e, 'drop3')}
        >
          <NavLink to={HELP_PAGE_LINKS.default} activeClassName="is-active">
            <span>
              <TI18n keyStr="headerMenuItem3" />
            </span>
            <i></i>
          </NavLink>
          <ul className="dropdown" onClick={e => stopFloatinUp(e)}>
            ...
            <li>
              <NavLink
                to={HELP_PAGE_LINKS.stuff}
                activeClassName="is-active"
                isActive={(match, location) =>
                  (location.pathname + location.search).includes(
                    HELP_PAGE_LINKS.stuff,
                  )
                }
              >
            ...
            <li>
              <NavLink
                to={HELP_PAGE_LINKS.volunteering}
                activeClassName="is-active"
                isActive={(match, location) =>
                  (location.pathname + location.search).includes(
                    HELP_PAGE_LINKS.volunteering,
                  )
                }
              >
        ...
        <li
          className={stateMenu.drop1 ? 'active nav-item drop' : 'nav-item drop'}
          onClick={e => openedMenu(e, 'drop1')}
        >
          <NavLink to="/about" activeClassName="is-active">
            <span>
              <TI18n keyStr="headerMenuItem1" />
            </span>
            <i></i>
          </NavLink>
          <ul className="dropdown" onClick={e => stopFloatinUp(e)}>
            ...
            <li>
              <NavLink
                to={`/about${RULES_PAGE_LINK}`}
                activeClassName="is-active"
              >
                <TI18n keyStr="headerMenuItem1Dropdown2" />
              </NavLink>
            </li>
            <li>
              <NavLink
                ...
                activeClassName="is-active"
              >
                <TI18n keyStr="headerMenuItem1Dropdown3" />
              </NavLink>
            </li>
          </ul>
        </li>
        <li className="nav-item">
          <NavLink to="/blog/page/1" activeClassName="is-active">
            <TI18n keyStr="blog" />
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink activeClassName="is-active" to="/contacts">
            <TI18n keyStr="contacts" />
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink
