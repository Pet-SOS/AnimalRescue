...
export class FavoritesPage extends React.Component<IPropTypes> {
  ...
  public componentWillUpdate(nextProps: IPropTypes): void {
    if (
      this.props.favoriteAnimalsIds.length < nextProps.favoriteAnimalsIds.length
    ) {
        ...
        <div className="favorites-page-holder">
          <div className="container">
            ...
            {this.favoriteAnimalsCount() === 0 && (
              <div className="text">
                <TI18n
                  keyStr="noneFavoriteAnimalsText"
          ...
          {this.favoriteAnimalsCount() === 0 && (
            <div className="animals-slider-wrapper">
              {this.props.dogsList.data && this.props.dogsList.data.length > 0 && (
                <AnimalsSlider
                  data={this.props.dogsList.data}
                  title={
                    <TI18n keyStr="dogsListTitle" default="Наши собачки" />
                  }
                  link={{
                    title: (
                      <TI18n
                        keyStr="wantToChooseFriend"
              ...
              {this.props.catsList.data && this.props.catsList.data.length > 0 && (
                <AnimalsSlider
          ...
          <div className="container">
            <section className="section-margin">
              {this.favoriteAnimalsCount() > 0 &&
                this.props.favoriteAnimalsList.data &&
                this.props.favoriteAnimalsList.data.length > 0 && (
                  <div className="content-block-animals">
                    {this.props.favoriteAnimalsList.data.length &&
                      this.props.favoriteAnimalsList.data.map(animal => (
