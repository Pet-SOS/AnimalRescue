...
export const selectAnimalsList = (state: ICustomAppState): IAnimalsListState => state[ANIMALS_KEY].animalsList;
export const selectSickAnimals = (state: ICustomAppState): IAnimalsListState => state[ANIMALS_KEY].sickAnimalsList;
export const selectDogsList = (state: ICustomAppState): IAnimalsListState => state[ANIMALS_KEY].dogsList;
