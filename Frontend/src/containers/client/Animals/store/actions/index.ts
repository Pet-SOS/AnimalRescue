...
export const actionFetchDogsRequest = createAction(
  'FETCH_DOGS_REQUEST',
  resolve => (requestParams?: IRequestParams) =>
    resolve({
      ...requestParams,
      filter: {
...
export const actionClearAnimalsList = createAction('CLEAR_ANIMALS');
...
export const actionClearDogs = createAction('CLEAR_DOGS');
...
export const actionClearCats = createAction('CLEAR_CATS');
...
export const actionClearSickAnimals = createAction('CLEAR_SICK_ANIMALS');
