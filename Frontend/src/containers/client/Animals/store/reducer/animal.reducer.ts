...
import { IAnimalItemState, DEFAULT_ANIMAL_ITEM_STATE } from "../state/animal.state";
...
export const animalItemReducer = (state: IAnimalItemState = DEFAULT_ANIMAL_ITEM_STATE, action: AnyAction): IAnimalItemState => {
  switch (action.type) {
